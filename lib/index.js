...
var Logger = (function () {
    function Logger(prefix, severity) {
        var _this = this;
        this.severityMap = {
            1: "error",
            2: "warn",
        ...
        this.logPrefix = "";
        this.loghistory = [];
        this.severity = Logger.severity.warn;
        this.pad = function (n) {
            return n < 10 ? "0" + n : "" + (n + "");
        };
    ...
    Logger.getInstance = function (prefix, severity) {
        if (!this.__instance) {
    ...
    Logger.prototype.dump = function () {
        for (var _i = 0, _a = this.loghistory; _i < _a.length; _i++) {
            var item = _a[_i];
            this.writeToConsole.apply(this, [item.severity].concat(item.message));
        }
        return;
    };
